...
# Font file paths
font_path_simhei = 'SimHei.ttf'  # Update this path if necessary
font_path_arial = 'Arial Unicode MS.ttf'  # Update this path if necessary

# Create FontProperties objects for each font
font_prop_simhei = fm.FontProperties(fname=font_path_simhei)
font_prop_arial = fm.FontProperties(fname=font_path_arial)

# Update matplotlib configuration
mpl.rcParams['font.sans-serif'] = [font_prop_simhei.get_name(), font_prop_arial.get_name()]
